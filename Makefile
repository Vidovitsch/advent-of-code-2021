...
.PHONY: 16_1
16_1: ensure-poetry
	@poetry run python ./solutions/day_16/part_1.py

.PHONY: 16_2
16_2: ensure-poetry
	@poetry run python ./solutions/day_16/part_2.py

.PHONY: 17_1
17_1: ensure-poetry
	@poetry run python ./solutions/day_17/part_1.py

.PHONY: 17_2
17_2: ensure-poetry
	@poetry run python ./solutions/day_17/part_2.py

.PHONY: 18_1
18_1: ensure-poetry
	@poetry run python ./solutions/day_18/part_1.py
...
.PHONY: 20_1
20_1: ensure-poetry
	@poetry run python ./solutions/day_20/part_1.py

.PHONY: 20_2
20_2: ensure-poetry
	@poetry run python ./solutions/day_20/part_2.py
