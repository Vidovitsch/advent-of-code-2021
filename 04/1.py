...
if __name__ == '__main__':
  (Puzzle('Day 4: Giant Squid (part 1)', CURRENT / 'input.txt')
    .add_test({ 'input_path': CURRENT / 'test.txt', 'expected_result': 4512 })
    .add_test({ 'input_path': CURRENT / 'input.txt', 'expected_result': 25410 })
    .solve(solve))
