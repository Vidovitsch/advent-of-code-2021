...
if __name__ == '__main__':
  (Puzzle('Day 5 - Part 2', CURRENT / 'input.txt')
    .set_input_processor(process_input)
    .add_test({ 'input_path': CURRENT / 'test.txt', 'expected_result': 12 })
    .add_test({ 'input_path': CURRENT / 'input.txt', 'expected_result': 20898 })
    .solve(solve))
