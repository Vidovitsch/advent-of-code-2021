...
if __name__ == '__main__':
  (Puzzle('Day 1: Sonar Sweep (part 1)', CURRENT / 'input.txt')
    .add_test({ 'input_path': CURRENT / 'test.txt', 'expected_result': 7 })
    .add_test({ 'input_path': CURRENT / 'input.txt', 'expected_result': 1832 })
    .solve(solve))
